...
1. Clone o repositório [conta_bancaria](https://github.com/Paulogsbrito/Conta_Bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Paulogsbrito/Conta_Bancaria.git
```
...
Desenvolvido por [**Paulo Gustavo Brito**](https://github.com/conteudoGeneration)
